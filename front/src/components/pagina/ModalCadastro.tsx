    ...
    <Overlay>
      ...
      >
        {status === "loading" ? (
          ...
          <Message>Cadastro concluído com sucesso!</Message>
        ) : status === "error" ? (
          <Message>Erro ao cadastrar usuário!</Message>
        ) : (
          <>
            <Header>Confirmar o cadastro</Header>
            <Content>
              <span>Deseja confirmar o cadastro?</span>
            </Content>
            <Divider />
            <ButtonRow>
